...
**DataOutputStream** 是用来装饰其它输出流，将DataOutputStream和**[DataInputStream](http://www.cnblogs.com/skywang12345/p/io_14.html)**输入流配合使用，“允许应用程序以与机器无关方式从底层输入流中读写基本 Java 数据类型”。
